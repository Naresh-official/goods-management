			...
			<div className="px-8 py-6">
					...
					<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
						<div>
							...
							<p className="text-slate-600">
								Manage all your product brands and manufacturers
							</p>
						</div>
				...
				{data && data.length === 0 && (
					<div className="text-center py-12">
						<SiBrandfolder className="w-16 h-16 text-slate-300 mx-auto mb-4" />
				...
				<div className="flex items-start justify-between mb-4">
					<div className="flex items-center">
						<div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center mr-3">
							<SiBrandfolder className="w-5 h-5 text-purple-600" />
						</div>
						<div>
							<h3 className="text-lg font-semibold text-slate-800 group-hover:text-purple-700 transition-colors duration-200">
								{data.name}
							</h3>
						</div>
					</div>
					...
					>
						<MdEdit className="w-4 h-4 text-slate-500 hover:text-purple-600" />
					</NavLink>
				</div>
